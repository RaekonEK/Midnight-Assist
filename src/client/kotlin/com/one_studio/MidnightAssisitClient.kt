...
UseItemCallback.EVENT.register { pl, w, hand ->
val stack = pl.getStackInHand(hand)
...
cl.getNetworkHandler()?.sendPacket(net.minecraft.network.packet.c2s.play.PlayerMoveC2SPacket.LookAndOnGround(k, l, pl.isOnGround()))
