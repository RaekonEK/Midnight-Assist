...
private class CameraSpring(start: Vec3, aimSpeed: Float = 0.5f) {
    ...
    private val stiffness = aimSpeed * 120f + 1f
    private val damping = 2f * sqrt(stiffness) * 1.0f
...
private class LockOnCamera(start: Vec3, startYaw: Float = 0f, startPitch: Float = 0f, aimSpeed: Float = 0.5f) {
    ...
    var pitch = startPitch
        private set
    private val rotSpeed = (aimSpeed * 40f).coerceAtLeast(0.01f)
    ...
    companion object {
        private const val predictionTime = 0.08f
