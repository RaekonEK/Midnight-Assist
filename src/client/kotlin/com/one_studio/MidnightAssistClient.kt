...
if (hi.isAlive && MidnightAssistConfig.isEntityEnabled(hi) && hi !is Player) {
he = true
}
}
if (!he) {
...
if (!isAttackPressed(cl)) return@EndTick

val cx = cl.hitResult
if (cx != null && cx.type == HitResult.Type.ENTITY) {
val hi = (cx as EntityHitResult).entity
if (hi.isAlive && hi !is Player) {
val cd = pl.getAttackStrengthScale(0.0f)
...
if (ins.screen != null) return false
...
private fun er(pl: Player): Double {
return if (pl.abilities.instabuild) 5.0 else 3.0
}
...
if (cl.screen != null) return false
